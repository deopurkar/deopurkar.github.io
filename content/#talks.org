...
:year:     2026
:type:     Workshop
:meet: Workshop in algebraic geometry
:end:

* How to count using equivariant cohomology
:properties:
:institute: Banff International Research Institute/Chennai Mathematical Institute
:place:    Chennai, India
:year:     2026
:type:     Workshop
:meet: Geometric and category-theoretic approaches to conformal field theory
:end:
