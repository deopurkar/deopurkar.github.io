# Created 2025-04-03 Thu 22:13
#+options: toc:nil ':t tags:nil broken-links:ignore prop:t
#+title: 2024 Algebra 2
#+author: Anand Deopurkar
:PROPERTIES:
:ID:       c90337d7-7033-4cce-9546-c18524d48edd
:END:
#+tags: teaching(t) admin(a)
#+archive: ::* Finished tasks
#+filetags: teaching 2024algebra2
#+category: Teaching
#+bind: org-export-use-babel nil
#+export_file_name: ~/website/content/teaching/2024_algebra2/index.org
...
|----------------------+----------------------------------------------------+------------------|
| [[Week 1][Week 1]]   | Algebraicity and transcendence                     | 15.1, 15.2       |
| [[Week 2][Week 2]]   | Degree, constructibility                           | 15.3, 15.4, 15.5 |
| [[Week 3][Week 3]]   | Factorisation of polynomials                       | 12.3, 12.4       |
| [[Week 4][Week 4]]   | Fundamental theorem of algebra, adjoining roots    | 15.10, 15.6      |
| [[Week 5][Week 5]]   | Finite fields                                      | 15.8             |
| [[Week 6][Week 6]]   | Primitive elements, function fields                | 15.8, 15.9       |
| [[Week 7][Week 7]]   | Introduction to Galois theory, symmetric functions | 16.1, 16.2       |
| [[Week 8][Week 8]]   | Splitting fields, symmetries of field extensions   | 16.3, 16.4       |
| [[Week 9][Week 9]]   | Fixed fields, main theorem of Galois theory        | 16.5, 16.6, 16.7 |
| [[Week 10][Week 10]] | Cubics, quartics                                   | 16.8, 16.9       |
| [[Week 11][Week 11]] | Roots of unity, Kummer extensions                  | 16.10, 16.11     |
| [[Week 12][Week 12]] | Solvability, Constructibility revisited            | 16.12            |
#+end:
** Announcements
*** Quiz 1
...
** Homework 1
:PROPERTIES:
:EXPORT_FILE_NAME: 2024algebra2p/homework/hw01.pdf
...
*** Problem 4 (15.3.5)
:PROPERTIES:
:ID:       2c9c1c40-eca4-4afe-a94c-6c9fead706fa
:END:
...
** Homework 2
:PROPERTIES:
:EXPORT_FILE_NAME: 2024algebra2p/homework/hw02.pdf
:EXPORT_OPTIONS: toc:nil ':t
:EXPORT_AUTHOR: 
:export_latex_class: amsart
:export_exclude_tags: solution
...
** Homework 3
:PROPERTIES:
:EXPORT_FILE_NAME: 2024algebra2p/homework/hw03.pdf
:EXPORT_OPTIONS: toc:nil ':t tags:nil
:EXPORT_AUTHOR: 
:export_latex_class: amsart
:export_exclude_tags: solution
:EXPORT_DATE: 
...
** Homework 4
:PROPERTIES:
:EXPORT_FILE_NAME: 2024algebra2p/homework/hw04.pdf
:EXPORT_OPTIONS: toc:nil ':t tags:nil
:EXPORT_AUTHOR: 
:export_latex_class: amsart
:export_exclude_tags: solution
...
** Homework 5
:PROPERTIES:
:EXPORT_FILE_NAME: 2024algebra2p/homework/hw05.pdf
:EXPORT_OPTIONS: toc:nil ':t tags:nil
:EXPORT_AUTHOR: 
:export_latex_class: amsart
...
:PROPERTIES:
:export_latex_class: amsart
:EXPORT_AUTHOR: 2024 Algebra 2
:EXPORT_OPTIONS: toc:nil ':t tags:nil
:EXPORT_FILE_NAME: 2024algebra2p/workshops/ws01sol.pdf
...
:EXPORT_AUTHOR: 2024 Algebra 2
:EXPORT_OPTIONS: toc:nil ':t tags:nil
:EXPORT_FILE_NAME: 2024algebra2p/workshops/ws02sol.pdf
:export_latex_class_options: [12pt]
:export_exclude_tags: 
:EXPORT_DATE: 
:END:
...
:EXPORT_AUTHOR: 2024 Algebra 2
:EXPORT_OPTIONS: toc:nil ':t tags:nil
:EXPORT_FILE_NAME: 2024algebra2p/workshops/ws03.pdf
:export_latex_class_options: [12pt]
:export_exclude_tags: solution
:EXPORT_DATE: 
:END:
...
:EXPORT_AUTHOR: 2024 Algebra 2
:EXPORT_OPTIONS: toc:nil ':t tags:nil
:EXPORT_FILE_NAME: 2024algebra2p/workshops/ws04sol.pdf
:export_latex_class_options: [12pt]
:export_exclude_tags: 
:EXPORT_DATE: 
:END:
...
:EXPORT_AUTHOR: 2024 Algebra 2
:EXPORT_OPTIONS: toc:nil ':t tags:nil
:EXPORT_FILE_NAME: 2024algebra2p/workshops/ws05sol.pdf
:export_latex_class_options: [12pt]
:export_latex_header_extra: \usepackage{fullpage}
:export_exclude_tags: 
:EXPORT_DATE: 
...
:PROPERTIES:
:export_title: Quiz 1
:export_author: Algebra 2, 2024
:export_latex_class: amsart
:EXPORT_OPTIONS: toc:nil ':t
:EXPORT_FILE_NAME: qz1_1
:export_latex_class_options: [12pt]
:EXPORT_DATE: 
:END:
...
1. Let \(\alpha \in \mathbf{C}\).
   Consider the statements:
   - (a) :: \(\alpha\) is transcendental over \(\mathbf{Q}\).
   - (b) :: \(\alpha^2\) is transcendental over \(\mathbf{Q}\).
...
2. What is the degree of \(\sqrt  2 + i\) over \(\mathbf{Q}[\sqrt 2]\)?
** Quiz 1 (version 2)
:PROPERTIES:
:export_latex_class: amsart
:export_title: Quiz 1
...
1. Let \(\alpha, \beta \in \mathbf{C}\) be algebraic over \(\mathbf{Q}\).

   - If \(\alpha\) and \(\beta\) have the same minimal polynomial, then \(\mathbf{Q}[\alpha] = \mathbf{Q}[\beta]\) as subsets of \(\mathbf{C}\).
   ...
   - If \(\mathbf{Q}[\alpha] = \mathbf{Q}[\beta]\), then \(\alpha\) and \(\beta\) have the same minimal polynomial.
...
2. Does \(\sqrt 2\) lie in \(\mathbf{Q}[i + \sqrt 2]\)?
...
- [ ] (Degree 6)\\
- [ ] (Degree 3) \(\times\) (Degree 3)\\
- [ ] (Degree 4) \(\times\) (Degree 2)\\
- [ ] (Degree 3) \(\times\) (Degree 2) \(\times\) (Degree 1)\\
- [ ] (Degree 2) \(\times\) (Degree 2) \(\times\) (Degree 2)\\
- [ ] Product of six (Degree 1).
** Quiz 2 (version 2)
:PROPERTIES:
:export_title: Quiz 2
:export_author: Algebra 2, 2024
...
1. \(a \in F\) generates the multiplicative group \(F^{\times}\).
2. \(a \in F\) generates \(F\), that is \(F = \mathbf{F}_3[a]\).

Pick the most accurate option:\\

- [ ] (1) \(\implies\) (2) but not conversely.\\

- [ ] (2) \(\implies\) (1) but not conversely.\\
...
1. \(\mathbf{Q} \subset \mathbf{Q}[\sqrt n \mid n = 2, \dots, 2024]\)\\

   \(\square\) Splitting field \qquad \(\square\)   Not a splitting field \\

2. \(\mathbf{F}_5 \subset \mathbf{F}_5[x]/(x^3+x+1)\)\\

   \(\square\) Splitting field \qquad \(\square\)   Not a splitting field \\

3. \(\mathbf{Q} \subset \mathbf{Q}[5^{1/3}]\)\\

   \(\square\) Splitting field \qquad \(\square\)   Not a splitting field \\


1. \(\mathbf{C}(t) \subset \mathbf{C}(t)[x]/(x^7-t^2)\)\\
...
1. The splitting field of \(x^4-x^2-x+2\) over \(\mathbf{F}_5\).  (This is an irreducible polynomial.)

   \vspace{3cm}

2. The splitting field of \(x^7 - t^2\) over \(\mathbf{C}(t)\).
...
\vspace{1cm}
*** Question 1
1. Does there exist an irreducible polynomial of degree 4 in \(\mathbf{Q}[x]\) whose Galois group is isomorphic to \(C_2 \times C_2\)?\\

   \qquad \(\square\) Yes \qquad \(\square\)   No \\

2. Does there exist an irreducible polynomial of degree 6 in \(\mathbf{Q}[x]\) whose Galois group is isomorphic to \(C_3 \times C_3\)?\\
...
1. Does there exist an irreducible polynomial of degree 4 in \(\mathbf{Q}[x]\) whose Galois group is isomorphic to \(C_2 \times C_2\)?\\
   ...
   \qquad \(\square\) Yes \qquad \(\square\)   No \\a
...
:PROPERTIES:
:EXPORT_FILE_NAME: ~/website/docs/teaching/2024algebra2/notes/index.html
:EXPORT_TITLE: Algebra 2 Course Notes
:export_html_head: <link rel="stylesheet" href="/css/main.css"></link><script src="/js/collapsibility.js"></script>
:html_headline_class: collapsible
:EXPORT_OPTIONS: toc:1 ':t
:END:
