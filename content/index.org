...
#+RESULTS:
:results:
- [[file:papers/CompStabGenK3.pdf][The Thurston compactification of the stability manifold of a generic analytic K3 surface]]. ([[https://arxiv.org/abs/2505.14991][arxiv]], [[https://github.com/deopurkar/CompStabGenK3][repository]])\\
  /Pre-print/.
...
- [[file:teaching/2014_algebra2/][Young tableaux in algebra and geometry]] ([[file:teaching/2014_algebra2/][2015]])
