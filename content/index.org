...
** Upcoming travel: Melbourne (July 2026) for a Workshop on Algebraic Geometry that I am organising with [[jackhall:][Jack Hall]] and [[norbury:][Paul Norbury]].
  ...
  (defun pretty-print ()
    (letrec ((title (org-entry-get nil "ITEM"))
  	   ...
  	   (more (org-entry-get nil "more"))
             (back-refs (collect-back-ref title "content/#talks.org")))
      (format "- %s.%s\\\\\n  /%s/%s%s.%s"
