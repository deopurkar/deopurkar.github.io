...
I am a mathematician working on questions in algebraic geometry and related areas.
I study the interplay between systems of algeraic equations and the geometric shapes they describe.
#+end_container
...
#+RESULTS:
:results:
- With [[jayan][Jayan Mukherjee]], I am trying to understand [[wiki:Linear_relation][syzygies]] of some non-reduced [[wiki:Algebraic_curve][algebraic curves]].
- With [[valery][Valery Alexeev]] and [[changho][Changho Han]], I am working on describing compact moduli spaces of some classes of [[wiki:K3_surface][K3 surfaces]].
...
- I am teaching a fun course called [[https://github.com/deopurkar/ggm2024][Games, graphs, and machines]], in which we talk about [[wiki:Graph][graphs]], [[wiki:Markov_chain][Markov chains]], [[wiki:Finite-state_machine][automata]], [[wiki:Regular_expression][regular expressions]], and games like [[wiki:Nim][Nim]] and [[wiki:Chomp][chomp]].
- I am also teaching a reading course based on Bott and Tu's famous book [[https://link.springer.com/book/10.1007/978-1-4757-3951-0][Differential forms in algebraic topology]].
- I am supervising Charlie Sherrat, who has been exploring the [[wiki:Geometric_invariant_theory][geometry and invariant theory]] of 3x3x4 hypercubes.
- I am supervising Luke Doherty, who is looking into the geometry of [[wiki:Linkage_(mechanical)][linkages]].
- With [[cobb:][John Cobb]], [[sione:][Sione Ma'u]], and [[hal:][Hal Schenk]], I am organising a special session at the [[https://ms-meet-2024.blogs.auckland.ac.nz/][joint NZMS/AustMS/AMS meeting]] in December 2024.
:end:

For things I have done, expand the headings below.
...
- Equivariant classes of orbits in GL(2)-representations. ([[https://raw.githubusercontent.com/deopurkar/equivariant-classes-of-gl2-orbits/main/gl2orbits.pdf][pdf]], [[https://arxiv.org/abs/2405.09849][arxiv]], [[https://github.com/deopurkar/equivariant-classes-of-gl2-orbits/][source/comments]])\\
  /Pre-print, arXiv:2405.09849/.
- Orbits of linear series on the projective line. ([[file:papers/erc.pdf][pdf]], [[https://arxiv.org/abs/2211.16603][arxiv]])\\
  /Pre-print, arXiv:2211.16603/, with [[https://sites.google.com/view/anand-patel][Anand Patel]].
...
:from:     [2024-07-01 Mon]
:to:       [2025-01-09 Thu]
:ID:       27c126e1-307b-4acf-9649-e938b0d9fd76
:END:
- With [[jayan][Jayan Mukherjee]], I am trying to understand [[wiki:Linear_relation][syzygies]] of some non-reduced [[wiki:Algebraic_curve][algebraic curves]].
- With [[valery][Valery Alexeev]] and [[changho][Changho Han]], I am working on describing compact moduli spaces of some classes of [[wiki:K3_surface][K3 surfaces]].
- With [[asilata][Asilata Bapat]] and [[tony][Tony Licata]], I am studying [[wiki:Bridgeland_stability_condition][Bridgeland stability conditions]] on some triangulated categories.
