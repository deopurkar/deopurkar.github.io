...
#+begin_src elisp :exports results :results value raw drawer
  ...
  (defun pretty-print ()
    (letrec ((title (org-entry-get nil "ITEM"))
             ...
             (back-refs (collect-back-ref title "~/website/content/static/talks.org")))
      (format "- /%s/.\\\\\n  %s%s%s%s.%s"
              title
              journal
              (if comment
  ...
  (string-join (org-map-entries 'pretty-print "-expository" '("static/papers.org")) "\n")
#+end_src
...
- /Ramification divisors of general projections/.\\
  ...
  Talk: San Diego ([[file:talks/PR2020-UCSD.pdf][slides]]).
...
- /Compactifications of Hurwitz spaces/.\\
  ...
  Talks: Palo Alto ([[file:talks/Hdg2013.pdf][notes]]), Cambridge ([[file:talks/Hdg_Talk.pdf][notes]]).
  ...
  (defun pretty-print ()
      (let ((title (org-entry-get nil "ITEM"))
        ...
        (format "- %s, %s."
                title
                year)))
  (string-join (org-map-entries 'pretty-print "+hl" '("static/teaching.org")) "\n")
#+end_src
#+RESULTS:
:results:
