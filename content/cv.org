  ...
  (defun pretty-print ()
    (let ((title (org-entry-get nil "ITEM"))
      ...
      (format "- %s :: %s\\\\\n      %s, %s."
              ...
              place
              "")))
  (string-join (org-map-entries 'pretty-print nil '("data/positions.org")) "\n")
#+end_src
  ...
  (defun pretty-print ()
    (let ((degree (org-entry-get nil "ITEM"))
      ...
      (format "- %s :: %s\\\\\n %s, %s.\\\\\n       %s."
              ...
              comment
              "")))
  (string-join (org-map-entries 'pretty-print nil '("data/education.org")) "\n")
#+end_src
  ...
  (defun pretty-print ()
    (let ((title (org-entry-get nil "ITEM"))
      ...
      (format "- %s :: %s, %s."
              ...
              title
              org)))
  (string-join (org-map-entries 'pretty-print nil '("data/awards.org")) "\n")
#+end_src
      ...
      (let ((title (org-entry-get nil "ITEM"))
        ...
        (format "- %s :: %s.\\\\\n          /%s/%s%s%s."
                ...
                (if (and link include-links)
                    (format " (%s)" link)
                  "")))))
  (string-join (org-map-entries 'pretty-print "-pp-expository-thesis" '("data/papers.org")) "\n")
#+end_src
...
** Pre-prints
#+begin_src elisp :exports results :results value raw drawer
  (string-join (org-map-entries 'pretty-print "+pp" '("data/papers.org")) "\n")
#+end_src
...
#+begin_src elisp :exports results :results value raw drawer :lexical t
  ...
  (string-join (org-map-entries 'pretty-print nil '("data/supervision.org")) "\n")
#+end_src
      ...
      (let ((year (org-entry-get nil "year"))
        ...
        (format "- %s :: %s. /%s/%s%s."
                ...
                (if (and link include-links)
                    (format " (%s)" link)
                  "")))))
  (string-join (org-map-entries 'pretty-print nil '("data/talks.org")) "\n")
#+end_src
...
#+begin_src elisp :exports results :results value raw drawer :lexical t
  ...
  (string-join (org-map-entries 'pretty-print nil '("data/service.org")) "\n")
#+end_src
