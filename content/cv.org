...
#+begin_src elisp :results none :exports none
  ;; If we have not been explicitly told to exclude links, we include links.
  ...
  (defun pretty-print ()
    (let ((title (org-entry-get nil "ITEM"))
      ...
      (format "- %s :: %s\\\\\n      %s, %s."
              ...
              place
              "")))
  (string-join (org-map-entries 'pretty-print nil '("static/positions.org")) "\n")
#+end_src
  ...
  (defun pretty-print ()
    (let ((degree (org-entry-get nil "ITEM"))
      ...
      (format "- %s :: %s\\\\\n %s, %s.\\\\\n       %s."
              ...
              comment
              "")))
  (string-join (org-map-entries 'pretty-print nil '("static/education.org")) "\n")
#+end_src
  ...
  (defun pretty-print ()
    (let ((title (org-entry-get nil "ITEM"))
      ...
      (format "- %s :: %s, %s."
              ...
              title
              org)))
  (string-join (org-map-entries 'pretty-print nil '("static/awards.org")) "\n")
#+end_src
      ...
      (let ((title (org-entry-get nil "ITEM"))
        ...
        (format "- %s :: %s.\\\\\n          /%s/%s%s%s."
                ...
                (if (and link include-links)
                    (format " (%s)" link)
                  "")))))
  (string-join (org-map-entries 'pretty-print "-pp-expository-thesis" '("static/papers.org")) "\n")
#+end_src
#+RESULTS:
:results:
...
- Pre-prints ::
#+begin_src elisp :exports results :results value raw drawer
  (string-join (org-map-entries 'pretty-print "+pp" '("static/papers.org")) "\n")
#+end_src
...
#+begin_src elisp :exports results :results value raw drawer :lexical t
  ...
  (string-join (org-map-entries 'pretty-print nil '("static/supervision.org")) "\n")
#+end_src
      ...
      (let ((year (org-entry-get nil "year"))
        ...
        (format "- %s :: %s. /%s/%s%s."
                ...
                (if (and link include-links)
                    (format " (%s)" link)
                  "")))))
  (string-join (org-map-entries 'pretty-print nil '("static/talks.org")) "\n")
#+end_src
...
#+begin_src elisp :exports results :results value raw drawer :lexical t
  ...
  (string-join (org-map-entries 'pretty-print nil '("static/service.org")) "\n")
#+end_src
