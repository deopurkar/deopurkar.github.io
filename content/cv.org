...
- 2026 :: /[[id:b1ba9384-4b6a-47b1-888c-61cc0c828493][Equivariant classes of orbits in GL(2)-representations]]/.\\
...
- Pre-prints ::
#+begin_src elisp :exports results :results value raw drawer
  (string-join (org-map-entries 'pretty-print "+preprint" '("papers.org")) "\n")
#+end_src
