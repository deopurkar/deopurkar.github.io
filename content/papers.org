...
* The Hasse norm principle for A_4-quartic extensions of global function fields :preprint:
:PROPERTIES:
:where:    Pre-print
:with:  [[rachel:][Rachel Newton]], [[vaidehee:][Vaidehee Thatte]], [[rosa:][Rosa Winter]]
:when:     2025
:links:    [[file:papers/ARRV.pdf][pdf]], [[https://arxiv.org/abs/2609.02444][arxiv]]
:ID:       8ead606a-7de5-496b-a870-3caaf53ddadf
:END:
#+begin_abstract
...
:PROPERTIES:
:where:  Selecta Mathematica
:when:     2026
:links: [[file:papers/gl2orbits.pdf][pdf]], [[https://arxiv.org/abs/2405.09849][arxiv]], [[https://github.com/deopurkar/equivariant-classes-of-gl2-orbits/][repository]], [[https://rdcu.be/AsYZNMApSdwa][journal]]
...
:where:  Transactions of the American Mathematical Society
:when:     2021
