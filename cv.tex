...
\label{sec:org4a3f56b}
\begin{description}
\item[{2026}] \emph{\href{papers/CompStabGenK3.pdf}{The Thurston compactification of the stability manifold of a generic analytic K3 surface}}.\\[0pt]
Mathematical Research Letters (accepted).
\item[{---}] \emph{\href{papers/gl2orbits.pdf}{Equivariant classes of orbits in GL(2)-representations}}.\\[0pt]
Selecta Mathematica (accepted).
\item[{2024}] \emph{\href{papers/erc.pdf}{Orbits of linear series on the projective line}}.\\[0pt]
International Mathematics Research Notices (with \href{https://sites.google.com/view/anand-patel}{Anand Patel}).
\item[{---}] \emph{\href{papers/countingcubics.pdf}{A universal formula for counting cubic surfaces}}.\\[0pt]
...
\item[{2022}] \emph{\href{papers/2cy-algorithm.pdf}{Spherical objects and stability conditions on 2-Calabi--Yau quiver categories}}.\\[0pt]
Mathematische Zeitschrift (with \href{https://asilata.org}{Asilata Bapat}, \href{https://maths-people.anu.edu.au/\~licatat/Home.html}{Anthony Licata}).
\item[{---}] \emph{\href{papers/ebundle.pdf}{Vector bundles and finite covers}}.\\[0pt]
Forum of Mathematics, Sigma (with \href{https://sites.google.com/view/anand-patel}{Anand Patel}).
\item[{2021}] \emph{\href{papers/TrigonalKSBA.pdf}{Stable log surfaces, admissible covers, and canonical curves of genus 4}}.\\[0pt]
Transactions of the Americal Mathematical Society (with \href{https://sites.google.com/view/changho-han/}{Changho Han}).
\item[{2020}] \emph{\href{papers/PR.pdf}{Ramification divisors of general projections}}.\\[0pt]
...
\item[{2019}] \emph{\href{papers/StackyAdmissibleCovers.pdf}{Covers of stacky curves and limits of plane quintics}}.\\[0pt]
Transactions of the Americal Mathematical Society.
\item[{2018}] \emph{\href{papers/HigherMaroni.pdf}{Syzygy divisors on Hurwitz spaces}}.\\[0pt]
Contemporary Mathematics (with \href{https://sites.google.com/view/anand-patel}{Anand Patel}).
\item[{---}] \emph{\href{papers/RibbonGreen.pdf}{The canonical syzygy conjecture for ribbons}}.\\[0pt]
Mathematische Zeitschrift.
\item[{2016}] \emph{\href{papers/gitsyzygy.pdf}{Toward GIT stability of syzygies of canonical curves}}.\\[0pt]
Algebraic Geometry (with \href{https://sites.google.com/bc.edu/maksym-fedorchuk/}{Maksym Fedorchuk}, \href{https://faculty.fordham.edu/dswinarski/}{David Swinarski}).
\item[{2015}] \emph{\href{papers/PicH345.pdf}{The Picard rank conjecture for the Hurwitz spaces of degree up to five}}.\\[0pt]
Algebra \& Number Theory (with \href{https://sites.google.com/view/anand-patel}{Anand Patel}).
\item[{2014}] \emph{\href{papers/groebner.pdf}{Groebner techniques for ribbons}}.\\[0pt]
Albanian Journal of Mathematics (with \href{https://sites.google.com/bc.edu/maksym-fedorchuk/}{Maksym Fedorchuk}, \href{https://faculty.fordham.edu/dswinarski/}{David Swinarski}).
\item[{---}] \emph{\href{papers/CompHurwitz.pdf}{Compactifications of Hurwitz spaces}}.\\[0pt]
International Mathematics Research Notices.
\item[{2013}] \emph{\href{papers/TrigonalSlopes.pdf}{Sharp slope bounds for sweeping families of trigonal curves}}.\\[0pt]
Mathematical Research Letters (with \href{https://sites.google.com/view/anand-patel}{Anand Patel}).
\item[{---}] \emph{\href{papers/MarkedTrigonal.pdf}{Modular compactifications of the space of marked trigonal curves}}.\\[0pt]
...
\end{description}
\begin{description}
\item[{2025}] \emph{\href{papers/spherical-sphere.pdf}{A sphere of spherical objects}}.\\[0pt]
Pre-print (with \href{https://asilata.org}{Asilata Bapat}, \href{https://maths-people.anu.edu.au/\~licatat/Home.html}{Anthony Licata}).
\item[{2024}] \emph{\href{papers/k3z3.pdf}{Compactifications of moduli spaces of K3 surfaces with a higher-order nonsymplectic automorphism}}.\\[0pt]
...
\item[{---}] \emph{\href{papers/highergenusribbons.pdf}{Syzygies of canonical ribbons on higher genus curves}}.\\[0pt]
Pre-print (with \href{https://sites.google.com/view/mukherjeejayan}{Jayan Mukherjee}).
\item[{---}] \emph{\href{papers/3veroneseP2.pdf}{Counting 3-uple Veronese surfaces}}.\\[0pt]
Pre-print (with \href{https://sites.google.com/view/anand-patel}{Anand Patel}).
\item[{2020}] \emph{\href{papers/a2-compactification.pdf}{A Thurston compactification of the space of stability conditions}}.\\[0pt]
Pre-print (with \href{https://asilata.org}{Asilata Bapat}, \href{https://maths-people.anu.edu.au/\~licatat/Home.html}{Anthony Licata}).
\item[{2019}] \emph{\href{papers/lines\_on\_tropical\_cubics.pdf}{Anticanonical tropical cubic del Pezzos contain exactly 27 lines}}.\\[0pt]
Pre-print (with \href{https://people.math.osu.edu/cueto.5/}{María Angélica Cueto}).
\item[{2013}] \emph{\href{papers/CyclicAppendix.pdf}{Class of the Hodge eigenbundle using orbifold Riemann-Roch}}.\\[0pt]
...
\end{description}
\begin{description}
\item[{2025}] \emph{\href{papers/arithmetic\_covers.pdf}{The arithmetic and geometry of branched coverings: theorems of Belyi and Darmon--Granville}}.\\[0pt]
Pre-print.
\item[{2010}] \emph{\href{papers/anandrd\_minor\_thesis.pdf}{An introduction to intersection homology}}.\\[0pt]
Minor thesis (Harvard).
\item[{2008}] \emph{\href{papers/anandrd\_ug\_thesis.pdf}{Normalization of algebraic varieties}}.\\[0pt]
MIT Undergruate Journal of Mathematics.
\end{description}

\section*{Supervision}
\label{sec:orgdaa82cd}
\begin{description}
\item[{2026}] Liam Murray, Honours (with \href{https://sites.google.com/view/murmuno/}{Sveta Makarova}).
\item[{---}] Frey Boulton, Honours.
\item[{---}] James Porteous, Masters.
...
\label{sec:org8e0cc3c}
\begin{description}
\item[{2026}] \emph{Be wise, equivariantise!}. Workshop in algebraic geometry, University of Sydney, Sydney, Australia.
\item[{---}] \emph{How to count using equivariant cohomology}. Geometric and category-theoretic approaches to conformal field theory, Banff International Research Institute/Chennai Mathematical Institute, Chennai, India.
...
\item[{---}] Served on the PhD thesis committee of Alexander Lai De Oliveira, Mathematical Sciences Institute, Australian National University.
\item[{---}] Served on the PhD thesis committee of Seethalakshmi Kayanattath, Mathematical Sciences Institute, Australian National University.
\item[{---}] Served on the PhD thesis committee of Lucas Allen, Mathematical Sciences Institute, Australian National University.
\item[{---}] Headed the selection committee for the \emph{Future research talent fellowship}, Australian National University.
\item[{---}] Served on the PhD thesis committee of Kabeer Manali Rahul, Australian National University.
...
\item[{---}] Served on the MPhil thesis committee of Ivan Zelich, Mathematical Sciences Institute, Australian National University.
...
\item[{---}] Served on the award committee for the \emph{BH Neumann prize} for the best student talk, AustMS meeting.
