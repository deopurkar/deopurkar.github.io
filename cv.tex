...
International Mathematics Research Notices (with [BROKEN LINK: anandpatel:]).
\item[{---}] \emph{\href{papers/countingcubics.pdf}{A universal formula for counting cubic surfaces}}.\\[0pt]
Algebraic Geometry (to appear) (with [BROKEN LINK: anandpatel:], \href{https://sites.google.com/view/dennis-tseng}{Dennis Tseng}).
...
Forum of Mathematics, Sigma (with [BROKEN LINK: anandpatel:]).
...
Documenta Mathematica (with \href{https://eduryev.weebly.com/}{Eduard Duryev}, [BROKEN LINK: anandpatel:]).
...
Contemporary Mathematics (with [BROKEN LINK: anandpatel:]).
...
Algebraic Geometry (with [BROKEN LINK: maksym:], [BROKEN LINK: davidswinarski:]).
\item[{2015}] \emph{\href{papers/PicH345.pdf}{The Picard rank conjecture for the Hurwitz spaces of degree up to five}}.\\[0pt]
Algebra \& Number Theory (with [BROKEN LINK: anandpatel:]).
...
Mathematical Research Letters (with [BROKEN LINK: anandpatel:]).
...
Pre-print (with [BROKEN LINK: anandpatel:]).
...
\section*{Supervision}
\label{sec:org3b125b1}
\begin{description}
\item[{2026}] Liam Murray, Honours (with [BROKEN LINK: sveta:]).
