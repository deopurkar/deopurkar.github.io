...
\begin{description}
\item[{2025}] \emph{\href{papers/CompStabGenK3.pdf}{The Thurston compactification of the stability manifold of a generic analytic K3 surface}}.\\[0pt]
Pre-print.
...
\begin{itemize}
\item \href{papers/arithmetic\_covers.pdf}{The arithmetic and geometry of branched coverings: theorems of Belyi and Darmon--Granville}.\\[0pt]
\emph{Pre-print}.
\item \href{papers/anandrd\_minor\_thesis.pdf}{An introduction to intersection homology}.\\[0pt]
\emph{Minor thesis, Harvard, 2010}.
\item \href{papers/anandrd\_ug\_thesis.pdf}{Normalization of algebraic varieties}.\\[0pt]
\emph{MIT Undergruate Journal of Mathematics}.
\end{itemize}

\section*{Supervision}
\label{sec:org8802a3c}
\begin{verbatim}
;; Our pretty-printing function
(let ((previous ""))
  (defun pretty-print ()
