...
\label{sec:org91b9248}
\begin{description}
\item[{2022}] Forum of Mathematics, Sigma (accepted).\\
...
\label{sec:org0700bd9}
\begin{description}
\item[{2022}] Australian National University, Canberra, Australia. \emph{How to count using equivariant cohomology?}.
\item[{---}] Tsinghua University, Beijing, China. \emph{Combinatorics and dynamics of Harder-Narasimhan filtrations}.
