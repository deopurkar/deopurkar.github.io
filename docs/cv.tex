...
\author{\href{mailto:anand.deopurkar@anu.edu.au}{\texttt{anand.deopurkar@anu.edu.au}}}
\date{}
\title{Curriculum Vitae | Anand Deopurkar}
\hypersetup{
 pdfauthor={\href{mailto:anand.deopurkar@anu.edu.au}{\texttt{anand.deopurkar@anu.edu.au}}},
...
\item[{2016}] Workshop funding, American Institute of Mathematics.
...
\section*{Supervision}
\label{sec:org37ed338}
\begin{description}
\item[{2021}] Zongpu Zhang, Honours.
\item[{---}] Donghoon Shin, Honours, with Danesh Jogia (Australian Signals Directorate).
...
\label{sec:org36cbac7}
\begin{description}
\item[{2022}] Institute for Computational and Experimental Research in Mathematics, Providence, Rhode Island, Braids in representation theory and algebraic combinatorics. \emph{The geometry and combinatorics of Harder--Narasimhan filtrations}.
