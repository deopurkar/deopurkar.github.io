...
\label{sec:orge2bea11}
\begin{description}
\item[{2022}] ICERM, Brown University, Providence, Rhode Island, Braids in Symplectic and Algebraic Geometry. \emph{Braids and monodromy in algebraic geometry} (preparatory talk for the conference).
