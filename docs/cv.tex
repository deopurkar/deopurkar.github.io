...
\label{sec:orge0b3871}
\begin{description}
\item[{2022}] Bhaskaracharya Pratishthana, Pune, India, Trimester program on triangle groups, Belyi uniformization, and modularity. \emph{The geometry of Fermat-like equations} (expository).
